    ...
    initRow: function(params) {
        ...
        function drawRuler(count) {
            ...
            for (let i = 0; i < initParams.maxScale; i++) {
                ...
                cxt.lineTo(x, Math.floor(initParams.height * 0.2))
                if (i % 5 === 0) {
                ...
                if (i % 10 === 0) {
                    ...
                    cxt.fillText(String(i * division), x + 2, Math.floor(initParams.height * 0.7))
                }
                cxt.stroke()
                cxt.restore()
                cxt.closePath()
    ...
    initColumn: function(params) {
        ...
        function drawRuler(count) {
            ...
            for (let i = 0; i < initParams.maxScale; i++) {
                ...
                cxt.moveTo(0, y)
                cxt.lineTo(Math.floor(initParams.width * 0.2), y)
                if (i % 5 === 0) {
                    cxt.strokeStyle = initParams.color ? initParams.color : '#666'
                ...
                if (i % 10 === 0) {
                    ...
                    cxt.textBaseline = 'middle'
                    cxt.lineTo(0, y)
                    cxt.fillText(String(i * division), Math.floor(initParams.width * 0.1), y + 8)
                }
                cxt.stroke()
                cxt.restore()
                cxt.closePath()
